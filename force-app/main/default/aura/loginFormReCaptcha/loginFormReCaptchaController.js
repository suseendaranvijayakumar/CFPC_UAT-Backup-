({
    ...
    doSubmit: function (component, event, helper){
        ...
        var action = component.get("c.loginReCaptcha");
        var startUrl = component.get("v.startUrl");
        var recaptchaResponse = component.get('v.recaptchaResponse');

        startUrl = decodeURIComponent(startUrl);

        action.setParams({username:username, password:password, startUrl:startUrl, recaptchaResponse:recaptchaResponse});
